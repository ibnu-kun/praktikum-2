...
unset($__errorArgs, $__bag); ?>
 ...
 m-0
 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none
 " name="code" value="<?php echo e(old('code', $product->code)); ?>" readonly>
...
unset($__errorArgs, $__bag); ?>
 ...
 m-0
 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none
 " name="price" value="<?php echo e(old('price', $product->price)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
 ...
 m-0
 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none
 " name="stock" value="<?php echo e(old('stock', $product->stock)); ?>" required>
...
</html><?php /**PATH C:\xampp\htdocs\sample-app\resources\views/products/edit.blade.php ENDPATH**/ ?>